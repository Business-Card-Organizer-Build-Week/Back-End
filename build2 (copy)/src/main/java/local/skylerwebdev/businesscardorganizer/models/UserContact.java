...
public class UserContact extends Auditable implements Serializable
{
    ...
    private List<SavedContacts> savedContacts;
...
//    private List<SavedContacts> savedcontacts = new ArrayList<>();
    ...
    public UserContact(@Email String useremail, String fname, String lname, String busname, String userphone, String useraddress, String usercity, String userState, String userzip, User user, UserContactType usercontacttype)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        return contactid == that.contactid &&
                ...
                Objects.equals(savedContacts, that.savedContacts);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(contactid, useremail, fname, lname, busname, userphone, useraddress, usercity, userState, userzip, user, usercontacttype, savedContacts);
    }
