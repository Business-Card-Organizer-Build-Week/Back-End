...
//        userService.addSavedContact(u1, );
        ...
        u2.getUserContacts()
                .add(new UserContact("test@test.com",u2.getFname(),u2.getLname(),u2.getBusname(), "5555555555", "TestAddress", "Test City", "ST", "55555", u2,ct3));
        ...
        u3.getUserContacts()
                .add(new UserContact("test@test.com",u3.getFname(),u3.getLname(),u3.getBusname(), "5555555555", "TestAddress", "Test City", "ST", "55555", u1,ct1));
        ...
        UserContact ct1test = new UserContact("test@test.com",u2.getFname(),u2.getLname(),u2.getBusname(),"1234567891","TestAddress","TestCity","TS","5555555",u5,ct1);
