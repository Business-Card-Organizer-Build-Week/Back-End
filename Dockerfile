...
# Setup prompt
#
RUN echo 'export PS1="[Backend for Business Card Organizer] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[Backend for Business Card Organizer] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)Backend for Business Card Organizer$(tput sgr0).\n\
\n\
